...
const EducationItem: React.FC<{ 
  ...
  return (
    <div className={`relative flex flex-col md:flex-row items-center justify-between w-full mb-16 md:mb-24 ${isLeft ? 'md:flex-row-reverse' : ''}`}>
      ...
      {/* Timeline Icon */}
      <div className="relative md:absolute md:left-1/2 md:-translate-x-1/2 w-12 h-12 rounded-full bg-[#0a0f1e] border border-purple-500/50 z-20 flex items-center justify-center shadow-[0_0_20px_rgba(168,85,247,0.4)] mb-6 md:mb-0">
        {icon}
        <motion.div 
      ...
      >
        <div className={`glass-panel p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] border-white/5 royal-glow relative group gold-border text-left md:${isLeft ? 'text-right' : 'text-left'}`}>

          {/* Year & Score */}
          <div className={`flex flex-wrap items-center gap-3 mb-4 ${isLeft ? 'md:justify-end' : 'md:justify-start'}`}>
          ...
          <h4 className="text-xl md:text-2xl font-royal mb-2 text-white group-hover:text-purple-400 transition-colors">
            {title}
          </h4>
    ...
    <div className="py-12">
      <div className="text-center mb-16 md:mb-24">
        <motion.div 
          ...
          className="text-purple-500 text-[11px] font-semibold tracking-[0.6em] md:tracking-[0.8em] uppercase mb-6"
        >
          Academic Lineage
        </motion.div>
        ...
        <motion.h3 
          ...
          className="text-4xl md:text-7xl font-royal uppercase tracking-tighter"
        >
          Education
        </motion.h3>
      </div>
      ...
      <div className="relative max-w-5xl mx-auto px-4 md:px-0">
        ...
        <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-[1px] bg-gradient-to-b from-transparent via-purple-500/30 to-transparent -translate-x-1/2" />
